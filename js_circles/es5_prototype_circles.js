var chosenColor = "#b6d6a8";

function CircleGenerator() {
    this.chosenColor = "#b6d6a8";
}

CircleGenerator.prototype.chooseColor = function (color) {
    var colorMap = {
        green: "#b6d6a8",
        blue: "#9fc4f7",
        purple: "#b4a6d5",
    ...
    this.chosenColor = colorMap[color];
...
CircleGenerator.prototype.resetScreen = function () {
    // Clear all circles on the screen
    var circles = document.getElementsByClassName("shrink-circle");
...
CircleGenerator.prototype.createCircle = function (
    x,
    y,
    radius,
    backgroundColor
...
var circleGenerator = new CircleGenerator();
...
document.addEventListener("click", function (event) {
    ...
    var randomRadius = Math.floor(Math.random() * 191) + 10;
    circleGenerator.createCircle(
        event.clientX,
        event.clientY,
        randomRadius,
        circleGenerator.chosenColor
    );
});
